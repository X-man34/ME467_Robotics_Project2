...
from filters import HybridMahonyTriadFilter
...
if __name__ == "__main__":
    ...
    # csv_data = pd.read_csv('csv_files\charlie_phone_540.csv')
    ...
    mahony_filter = HybridMahonyTriadFilter(dT=.01,threshold=0.05, kp=1.0, kI=0.3, ka_nominal=.8, km_nominal=.2)
